  ...
  return (
    <nav className= "bg-gray-50  bg-opacity-50 backdrop-blur-lg border-b border-white/20 shadow-md fixed w-full  top-0 z-10 flex">
        ...
        <div className='container px-0 ml-5 my-5 flex item-center'> 
           ...
           <div className='  ml-auto mx-0  bg-transparent'>
            <ul className='hidden md:flex gap-12 md:items-center  absolute md:static mx-5'>
              <a href="#home" className="navbar-link text-lightbrown hover:bg-orange-200 hover:text-blue-400">Home</a>
              <a href="#about" className="navbar-link  text-lightbrown hover:bg-orange-200 hover:text-blue-400">Features</a>
              <a href="#menu" className="navbar-link  text-lightbrown hover:bg-orange-200 hover:text-blue-400">About</a>
              <a href="#contact" className="navbar-link  text-lightbrown hover:bg-orange-200 hover:text-blue-400">Contact</a>
          </ul>
        </div>
        {/* menu section */}
        </div>
        ...
        <IoReorderThreeOutline  className=' h-full w-10' onClick={() => setIsMenuOpen(!isMenuOpen)} />
             ...
             style={{transition:"transform 0.3s ease ,opacity-100"}}>
