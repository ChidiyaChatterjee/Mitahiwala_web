    ...
    > 
      <div className="text-left mx-16">
        <h1 className="text-4xl md:text-6xl font-bold text-white">
          Welcome <br /> to Our{' '}
          <span
            className='font-cursive text-6xl md:text-9xl text-white transition-transform duration-100 ease-linear'
            style={{
        ...
        <p className="text-sm md:text-xl mt-4 text-white">
          Where tradition <br /> meets quality, our bakery crafts <br /> each item to perfection using time-honored <br /> techniques and the finest ingredients.
        </p>
      </div>
    </section>
  );
